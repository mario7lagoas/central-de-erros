...
public class CentralErrosExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        String mensagemUsuario = "Messagem invalida.";
    ...
    private List<Erro> criarListaDeErros(BindingResult bindingResult){
        ...
        for ( FieldError fieldError : bindingResult.getFieldErrors() ) {
           // String mensagemUsusario = messageSource.getMessage(fieldError, LocaleContextHolder.getLocale());
            String mensagemUsuario = "Erros :";
            String mensagemDesenvolverdor = fieldError.toString();

            erros.add(new Erro(mensagemUsuario, mensagemDesenvolverdor));
        }
    ...
    public ResponseEntity<Object> EmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request){
        ...
        String mensagemUsuario = "Recuros nao encontrado";
    ...
    public ResponseEntity<Object> HandleDataIntegrityViolationException(DataIntegrityViolationException ex,WebRequest request){
        String mensagemUsuario = "Operacao nao permitida.";
